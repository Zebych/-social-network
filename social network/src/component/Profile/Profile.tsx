...
const Profile: React.FC<ProfileProps> = (
    {
        profilePage, getStatus, saveProfile, updateStatus, isOwner, savePhoto
    }) => {
    return (
        <div className={c.profile}>
            <ProfileInfo profilePage={profilePage} getStatus={getStatus} updateStatus={updateStatus} isOwner={isOwner}
